    ...
    return (
        <section id={id} className='d-flex justify-content-center'>
            <div className='d-flex flex-row'>
                ...
                <a href='https://www.facebook.com/bitwaoslask/' className='mx-1 d-flex justify-content-center align-items-center bg-black rounded' style={{ height: '90px', aspectRatio: '1', maxWidth: '100px' }}>
                    <img src='img/tik-tok-cut.png' style={{ width: '54%' }} alt='ikona tik-toka' />
                </a>
                <a href='https://youtube.com' className='mx-1 d-flex justify-content-center align-items-center bg-primary rounded' style={{ height: '90px', aspectRatio: '1', maxWidth: '100px' }}>
